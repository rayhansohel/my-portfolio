    ...
    <>
      ...
      <div className="p-4 rounded-[40px] bg-base-100 border border-base-300 min-h-[calc(100vh-32px)] flex gap-4">
        ...
        <div className="flex-1 min-h-[calc(100vh-66px)] flex flex-col gap-4">
          ...
          <div className="w-full flex gap-4">
            {/* Photo  */}
            <div className="bg-base-200 w-60 h-60 rounded-[40px] p-4">
              <img
            ...
            {/* About  */}
            <div className="bg-base-200 h-full flex-1 rounded-[40px] border border-base-300 px-12 py-8 flex flex-col gap-2">
              ...
              <p>
                As a creative web developer and designer, I’m always excited to
                take on new projects and create something truly unique.
              </p>
            </div>
          </div>

          {/* Skills  */}
          <div className="bg-base-200 w-full rounded-[40px] flex flex-1 border border-base-300"></div>

          <div className="w-full rounded-[40px] flex gap-4">
            <div className="bg-base-200 h-full flex-1 rounded-[40px] border border-base-300"></div>
            <div className="bg-base-200 w-64 h-64 rounded-[40px] border border-base-300"></div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 max-h-[calc(100vh-66px)] rounded-[40px]">
          <div className="flex gap-4">
            <div className="flex flex-col gap-4">
              <div className="bg-base-200 w-72 h-72 rounded-[40px] border border-base-300 p-4">
            ...
            <div className="min-w-[368px] rounded-3xl flex flex-col gap-4">
              <div className="flex gap-4">
                ...
                <div className="w-[176px] h-[176px] rounded-3xl grid">
                  <div className="bg-base-200 w-full h-full rounded-3xl border border-base-300"></div>
                </div>
              </div>
              <div className="w-full flex-1 bg-base-200 rounded-[40px] border border-base-300"></div>
            </div>
          </div>
          <div className="w-full flex-1 bg-base-200 rounded-[40px] border border-base-300"></div>
        </div>
